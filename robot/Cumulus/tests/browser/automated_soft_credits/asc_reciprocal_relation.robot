...
Test Case 2
    ...
    Edit Record Field Value              Related Opportunity Contact Role              Soft Credit
    Save Record
    ...
    # Click Button    Save
    &{opportunity2} =  API Create Opportunity    &{contact3}[AccountId]    Donation    Name=Reciprocal test $500 donation    Amount=500    ${ns}Primary_Contact__c=&{contact3}[Id]  
    Go To Page                              Details                              Opportunity                                
