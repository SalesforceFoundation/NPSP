...
Create a new opportunity for a contact with open donations
    [Documentation]     Enter an account with open donations, then clear it and enter a contact
    ...                 with open donations, then choose to create a new opp and process it
    [tags]  stable
    ...
    &{opportunity1} =     API Create Opportunity   ${account}[Id]    Donation
    ...                   StageName=Prospecting
    ...                   Amount=100
    ...                   CloseDate=${date}
    &{opportunity2} =     API Create Opportunity   ${contact}[AccountId]    Donation
    ...                   StageName=Prospecting
    ...                   Amount=100
    ...                   CloseDate=${date}
    ...
    Fill BGE Form    Donation Amount=20
