...
Match Based on Number of Days from Donation Date Functionality
    [Documentation]    The number of days from donation date field on the BGE wizard allows matching to be made
    ...                by providing a margin of error on the Donation Date field for a record.
    ...                If the gift created is within range of that date, gift is matched to the existing donation
    [tags]  stable
