...
Opportunity is Autoclosed when Overpaid
    [Documentation]    Create Open Opportunity and apply new payment of amount more than opportunity
    ...                amount and confirm that opportunity is closed when batch is processed
    [tags]  stable
