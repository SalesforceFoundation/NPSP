...
*** Keywords ***
Setup Variables
    [Documentation]       creating variables with namespace and date
...
Create Data Import Record
    [Documentation]       creating the data import record required for test
...
1 Delete Mappings And Process Batch
    [Documentation]    Delete the Currency1 field mapping on object 'CustomObject1'
    ...
    Verify Expected Values               nonns    CustomObject1__c
    ...    ${data_import_upd}[${org_ns}CustomObject1Imported__c]
...
2 Create Data Import with Custom Object via API and Verify Values
    [Documentation]        Create the Currency1 field mapping on object 'CustomObject1'
...
3 Update Mappings and Process Batch
    [Documentation]        Delete the Currency2 field mapping on object 'CustomObject1' if it exists
