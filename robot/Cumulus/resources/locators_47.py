...
npsp_lex_locators={
    ...
    'EngagementPlans_title':"//h1[@title='Engagement Plans']",
    'Related_Item_Menu':'css:li.oneActionsDropDown a.slds-button--icon-x-small',
    'obj-header':"//h1//*[text()='{}']",
    ...
    'related_actions_dropdown_menu': 'css: a.slds-button--icon-x-small[aria-expanded="true"]',
