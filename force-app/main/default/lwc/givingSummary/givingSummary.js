...
const DESKTOP_CLASSES = 'slds-text-align_left slds-border_right columns-desktop slds-p-left_medium to-uppercase';
...
export default class GivingSummary extends LightningElement {
    ...
    get lastElementClasses() {
        ...
        return 'columns-desktop slds-text-align_left slds-p-left_medium slds-var-p-bottom_small to-uppercase';
    }
