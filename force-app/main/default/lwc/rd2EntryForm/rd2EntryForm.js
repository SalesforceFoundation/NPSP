    ...
    async processCommitmentSubmit(allFields) {
        try {
            if (this.isElevateWidgetDisplayed()) {
                ...
                this.loadingText = (this.isExperienceSite && this.rd2State.paymentMethod === this.ACH) || this.rd2Service.getPaymentProcessingMessage(this.rd2State.paymentMethod).toLowerCase().includes(this.ELEVATE) ? '' : this.rd2Service.getPaymentProcessingMessage(this.rd2State.paymentMethod);
