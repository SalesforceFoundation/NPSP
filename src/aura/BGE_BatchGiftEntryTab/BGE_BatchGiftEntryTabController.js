    ...
    doInit: function (component, event) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === 'SUCCESS') {
                ...
                if (isOrgNamespaced) {
                    var listViewNamespaced = {'objectApiName': 'npsp__DataImportBatch__c', 'listName': 'npsp__Gift_Batches', 'isLoaded': true};
                    component.set('v.listView', listViewNamespaced);
                } else {
                    var listViewUnnamespaced = {'objectApiName': 'DataImportBatch__c', 'listName': 'Gift_Batches', 'isLoaded': true};
