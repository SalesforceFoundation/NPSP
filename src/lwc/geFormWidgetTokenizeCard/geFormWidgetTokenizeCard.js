...
import { format, getNamespace, setNamespace } from 'c/utilCommon';
...
export default class geFormWidgetTokenizeCard extends LightningElement {
    ...
    get tokenizeCardPageUrl() {
        const tokenizeCardPageName = setNamespace(
            TOKENIZE_CARD_PAGE_NAME,
            getNamespace(DATA_IMPORT_OBJECT.objectApiName));
