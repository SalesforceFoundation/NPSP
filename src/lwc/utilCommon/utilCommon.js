 ...
 * @param toReplace The pattern used to replace the last instance of toRemove.
 * @returns {*|void|string} A new string with the last instance replaced.
 */
const replaceLastInstanceOfWith = (subject, toRemove, toReplace) => {
    return subject && subject.replace(new RegExp(toRemove + '$'), toReplace);
}
